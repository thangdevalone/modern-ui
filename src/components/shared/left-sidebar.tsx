...
const links: {
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/docs/components/number-counter", label: "Number Counter", badge: "new" },
      ...
      { href: "/docs/components/sparkles-text", label: "Sparkles Text", badge: "new" },
      { href: "/docs/components/stepper", label: "Stepper" },
      { href: "/docs/components/typewriter-effect", label: "Typewriter Effect", badge: "new" },
