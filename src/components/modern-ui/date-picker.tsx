...
import { DayClickEventHandler, DayPicker, DateRange } from "react-day-picker"
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-auto p-0" align="start">
        <Calendar 
          mode="single" 
          // @ts-ignore - There's a type mismatch but this works in practice
...
export function MonthPicker({
  ...
  // Create a custom component to render month buttons
  const MonthView = () => {
    const monthNames = [
...
export function QuarterPicker({
  ...
  // Create a custom component to render quarter buttons
  const QuarterView = () => {
...
export function YearPicker({
  ...
  // Create a custom component to render year buttons
  const YearView = () => {
    ...
    return (
      <div className="p-3">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="font-medium">{decade} - {decade + 9}</div>
          <Button 
            variant="outline" 
            size="icon" 
            onClick={() => setDecade(d => d + 10)}
