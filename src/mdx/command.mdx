...
import { CommandPreview } from "@/app/docs/components/command/preview";
import { CommandInstallation } from "@/app/docs/components/command/components/command-installation";
import { BasicCommandDemo, CommandWithIconsDemo, CommandWithShortcutsDemo, CommandWithGroupsDemo, CommandDialogDemo } from "@/app/docs/components/command/components/command-demos";
