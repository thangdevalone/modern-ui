...
const CLIContent = () => {
  const commands = {
    npm: "npx @thangdevalone/modern-ui add badge",
    pnpm: "pnpm dlx @thangdevalone/modern-ui add badge",
    yarn: "yarn dlx @thangdevalone/modern-ui add badge",
    bun: "bunx --bun @thangdevalone/modern-ui add badge",
  };
  return (
    <div>
      <TerminalBlock
