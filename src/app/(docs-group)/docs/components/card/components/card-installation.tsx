...
const CLIContent = () => {
  const commands = {
    npm: "npx @thangdevalone/modern-ui add card",
    pnpm: "pnpm dlx @thangdevalone/modern-ui add card",
    yarn: "yarn dlx @thangdevalone/modern-ui add card",
    bun: "bunx --bun @thangdevalone/modern-ui add card",
  };
  return (
    <div>
      <TerminalBlock
