    ...
    <div className="w-full bg-background p-6 border rounded-md max-w-md">
      <Accordion type="multiple" className="w-full">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            This is the first section content. Multiple sections can be opened
            at once.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            This is the second section content. You can open this while the
            first is open.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
...
export function CustomAccordionDemo() {
  return (
    <Accordion
      type="single"
      collapsible
      className="w-full max-w-md border rounded-lg bg-background"
    >
