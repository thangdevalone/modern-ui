...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add accordion",
    pnpm: "pnpm dlx @modern-core/ui add accordion",
    yarn: "npx @modern-core/ui add accordion",
    bun: "bunx --bun @modern-core/ui add accordion",
  };
  return (
    <div>
      <TerminalBlock
