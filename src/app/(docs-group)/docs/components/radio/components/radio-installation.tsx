...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-pack/ui add radio",
    pnpm: "pnpm dlx @modern-pack/ui add radio",
    yarn: "npx @modern-pack/ui add radio",
    bun: "bunx --bun @modern-pack/ui add radio",
  };
  return (
    <div>
      <TerminalBlock
...
const ManualContent = () => {
  const { code, isLoading } = useComponentCode("radio");
...
export const RadioInstallation = () => {
