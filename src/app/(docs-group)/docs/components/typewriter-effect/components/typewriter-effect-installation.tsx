...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add typewriter-effect",
    pnpm: "pnpm dlx @modern-core/ui add typewriter-effect",
    yarn: "npx @modern-core/ui add typewriter-effect",
    bun: "bunx --bun @modern-core/ui add typewriter-effect",
  };
  return (
    <div>
      <TerminalBlock
