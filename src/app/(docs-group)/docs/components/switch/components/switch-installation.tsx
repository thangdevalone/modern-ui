...
const CLIContent = () => {
  const commands = {
    npm: "npx @thangdevalone/modern-ui add switch",
    pnpm: "pnpm dlx @thangdevalone/modern-ui add switch",
    yarn: "yarn dlx @thangdevalone/modern-ui add switch",
    bun: "bunx --bun @thangdevalone/modern-ui add switch",
  };
  return (
    <div>
      <TerminalBlock
