...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add breadcrumb",
    pnpm: "pnpm dlx @modern-core/ui add breadcrumb",
    yarn: "npx @modern-core/ui add breadcrumb",
    bun: "bunx --bun @modern-core/ui add breadcrumb",
  };
  return (
    <div>
      <TerminalBlock
