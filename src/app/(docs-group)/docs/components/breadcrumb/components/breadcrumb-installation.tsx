...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-kit/ui add breadcrumb",
    pnpm: "pnpm dlx @modern-kit/ui add breadcrumb",
    yarn: "npx @modern-kit/ui add breadcrumb",
    bun: "bunx --bun @modern-kit/ui add breadcrumb",
  };
  return (
    <div>
      <TerminalBlock
