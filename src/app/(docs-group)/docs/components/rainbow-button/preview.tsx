...
export const rainbowButtonCode = `import { RainbowButton } from "@/components/modern-ui/rainbow-button";
            
export function RainbowButtonDemo() {
  return <RainbowButton>Rainbow Button</RainbowButton>;
}`;

export const PreviewRainbowButton = () => {
    ...
    <>
      <Tabs value={activeTab} className="mb-8" onValueChange={(value) => setActiveTab(value)}>
        ...
        <TabsContent value="code" className="mt-2">
          <CodeBlock code={rainbowButtonCode} language={"tsx"} />
        </TabsContent>
      </Tabs>
    </>
  );
