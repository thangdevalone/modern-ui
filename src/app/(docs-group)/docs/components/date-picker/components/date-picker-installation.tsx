...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add date-picker",
    pnpm: "pnpm dlx @modern-core/ui add date-picker",
    yarn: "npx @modern-core/ui add date-picker",
    bun: "bunx --bun @modern-core/ui add date-picker",
  };
  return (
    <div>
      <TerminalBlock
