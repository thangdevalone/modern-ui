...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-kit/ui add date-picker",
    pnpm: "pnpm dlx @modern-kit/ui add date-picker",
    yarn: "npx @modern-kit/ui add date-picker",
    bun: "bunx --bun @modern-kit/ui add date-picker",
  };
  return (
    <div>
      <TerminalBlock
