...
const CLIContent = () => {
  const commands = {
    npm: "npx @thangdevalone/modern-ui add table",
    pnpm: "pnpm dlx @thangdevalone/modern-ui add table",
    yarn: "yarn dlx @thangdevalone/modern-ui add table",
    bun: "bunx --bun @thangdevalone/modern-ui add table",
  };
  return (
    <div>
      <TerminalBlock
