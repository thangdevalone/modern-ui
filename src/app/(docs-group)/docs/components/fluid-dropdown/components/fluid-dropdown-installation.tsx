...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add fluid-dropdown",
    pnpm: "pnpm dlx @modern-core/ui add fluid-dropdown",
    yarn: "npx @modern-core/ui add fluid-dropdown",
    bun: "bunx --bun @modern-core/ui add fluid-dropdown",
  };
  return (
    <div>
      <TerminalBlock
