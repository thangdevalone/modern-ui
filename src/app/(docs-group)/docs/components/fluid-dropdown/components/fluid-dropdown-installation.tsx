...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-kit/ui add fluid-dropdown",
    pnpm: "pnpm dlx @modern-kit/ui add fluid-dropdown",
    yarn: "npx @modern-kit/ui add fluid-dropdown",
    bun: "bunx --bun @modern-kit/ui add fluid-dropdown",
  };
  return (
    <div>
      <TerminalBlock
