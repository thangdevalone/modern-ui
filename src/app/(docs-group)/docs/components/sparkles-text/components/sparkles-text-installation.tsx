...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-kit/ui add sparkles-text",
    pnpm: "pnpm dlx @modern-kit/ui add sparkles-text",
    yarn: "npx @modern-kit/ui add sparkles-text",
    bun: "bunx --bun @modern-kit/ui add sparkles-text",
  };
  return (
    <div>
      <TerminalBlock
