...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add sparkles-text",
    pnpm: "pnpm dlx @modern-core/ui add sparkles-text",
    yarn: "npx @modern-core/ui add sparkles-text",
    bun: "bunx --bun @modern-core/ui add sparkles-text",
  };
  return (
    <div>
      <TerminalBlock
