...
const sparklesTextCode = `import { SparklesText } from "@/components/modern-ui/sparkles-text";

export function PreviewSparklesText() {
  return (
      ...
      >
        ...
        >
          ...
          <div className="flex justify-center items-center relative h-full z-10 min-h-[250px] not-prose">
            <SparklesText key={key}>Magic Text</SparklesText>
          </div>
