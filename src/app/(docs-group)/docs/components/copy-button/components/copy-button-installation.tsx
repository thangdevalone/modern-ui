...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add copy-button",
    pnpm: "pnpm dlx @modern-core/ui add copy-button",
    yarn: "npx @modern-core/ui add copy-button",
    bun: "bunx --bun @modern-core/ui add copy-button",
  };
  return (
    <div>
      <TerminalBlock
