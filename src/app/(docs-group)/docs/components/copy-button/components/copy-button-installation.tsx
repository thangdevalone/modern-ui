...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-kit/ui add copy-button",
    pnpm: "pnpm dlx @modern-kit/ui add copy-button",
    yarn: "npx @modern-kit/ui add copy-button",
    bun: "bunx --bun @modern-kit/ui add copy-button",
  };
  return (
    <div>
      <TerminalBlock
