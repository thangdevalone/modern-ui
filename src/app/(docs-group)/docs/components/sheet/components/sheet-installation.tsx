...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-pack/ui add sheet",
    pnpm: "pnpm dlx @modern-pack/ui add sheet",
    yarn: "npx @modern-pack/ui add sheet",
    bun: "bunx --bun @modern-pack/ui add sheet",
  };
  return (
    <div>
      <TerminalBlock
...
const ManualContent = () => {
  const { code, isLoading } = useComponentCode("sheet");
...
export const SheetInstallation = () => {
