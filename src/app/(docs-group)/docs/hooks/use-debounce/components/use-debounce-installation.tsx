...
const CLIContent = () => {
  const commands = {
    npm: "npx @thangdevalone/modern-ui add use-debounce",
    pnpm: "pnpm dlx @thangdevalone/modern-ui add use-debounce",
    yarn: "yarn dlx @thangdevalone/modern-ui add use-debounce",
    bun: "bunx --bun @thangdevalone/modern-ui add use-debounce",
  };
  return (
    <div>
      <TerminalBlock
