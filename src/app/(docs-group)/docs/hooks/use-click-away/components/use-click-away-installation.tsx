...
const CLIContent = () => {
  const commands = {
    npm: "npx @modern-core/ui add use-click-away",
    pnpm: "pnpm dlx @modern-core/ui add use-click-away",
    yarn: "npx @modern-core/ui add use-click-away",
    bun: "bunx --bun @modern-core/ui add use-click-away",
  };
  return (
    <div>
      <TerminalBlock
